...
import postBgImg from '@/assets/img/post-bg.jpg'
import postSampleImg from '@/assets/img/post-sample-image.jpg'
</script>
...
<template>
  <PageHeader :background-image="postBgImg">
    ...
    <span class="d-block mt-3 fst-italic" style="font-size: 1.1rem">
      Posted by <a href="#" class="text-white text-decoration-underline">Start Bootstrap</a>
      on August 24, 2019
    </span>
  </PageHeader>
    ...
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        <p>
          ...
          which there is no center because every point, or none, is center
          &mdash; an equal earth which all men occupy as equals. The airman's
          earth, if free men make it, will be truly round: a globe in practice,
          not in theory.
        </p>
        ...
        <figure class="my-4">
          <img class="img-fluid rounded" :src="postSampleImg" alt="Post sample" />
          <figcaption class="caption text-muted">
            To go places and do things that have never been done before &ndash;
        ...
        <p class="text-muted small">
          Placeholder text by
          <a href="http://spaceipsum.com/" target="_blank" rel="noopener">Space Ipsum</a>.
          Photographs by
          <a href="https://www.flickr.com/photos/nasacommons/" target="_blank" rel="noopener">NASA on The Commons</a>.
        </p>
      </div>
    </div>
  </article>
